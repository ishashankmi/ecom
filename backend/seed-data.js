  ...
  try {
    ...
    const products = [
      // Waterproofing Products
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, discount: 0}, {qty: 2, discount: 50}, {qty: 5, discount: 100}]),
      ...
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, discount: 0}, {qty: 2, discount: 25}, {qty: 4, discount: 50}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, discount: 0}, {qty: 2, discount: 10}, {qty: 10, discount: 30}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      ...
      // Adhesive Chemicals
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 320}, {qty: 10, price: 300}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 450}, {qty: 5, price: 420}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 180}, {qty: 12, price: 160}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      ...
      // Tools and Machines
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 1200}, {qty: 3, price: 1100}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 2800}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 450}, {qty: 5, price: 400}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      ...
      // Stone Polishing
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 380}, {qty: 6, price: 350}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 850}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      ...
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 2200}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      ...
      // Accessories
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 120}, {qty: 10, price: 100}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 85}, {qty: 12, price: 75}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      ...
      // House Maintenance
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 280}, {qty: 10, price: 260}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      },
      {
        ...
        sales_prices: JSON.stringify([{qty: 1, price: 650}, {qty: 4, price: 600}]),
        images: JSON.stringify([]), image: '/uploads/placeholder.png'
      }
    ];
